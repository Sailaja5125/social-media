  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      ...
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
        ...
        <TouchableOpacity>
          <Feather name="edit" size={24} color="#5e35c3" />
        </TouchableOpacity>
      </View>
              ...
              <View className="flex-row items-center justify-between mb-1">
                <View className="flex-row items-center gap-1">
                  ...
                  {conversation.user.verified && (
                    <Feather name="check-circle" size={16} color="#5e35c3" className="ml-1" />
                  )}
          ...
          <SafeAreaView className="flex-1">
            ...
            <View className="flex-row items-center px-4 py-3 border-b border-gray-100">
              <TouchableOpacity onPress={closeChatModal} className="mr-3">
                <Feather name="arrow-left" size={24} color="#5e35c3" />
              </TouchableOpacity>
              <Image
              ...
              <View className="flex-1">
                <View className="flex-row items-center">
                  ...
                  {selectedConversation.user.verified && (
                    <Feather name="check-circle" size={16} color="#5e35c3" />
                  )}
                </View>
                    ...
                    <View className={`flex-1 ${message.fromUser ? "items-end" : ""}`}>
                      <View
                        className={`rounded-2xl px-4 py-3 max-w-xs ${
                          message.fromUser ? "bg-[#5e35c3]" : "bg-gray-100"
                        }`}
                      >
            ...
            <View className="flex-row items-center px-4 py-3 border-t border-gray-100">
              ...
              <TouchableOpacity
                ...
                className={`size-10 rounded-full items-center justify-center ${
                  newMessage.trim() ? "bg-[#5e35c3]" : "bg-gray-300"
                }`}
